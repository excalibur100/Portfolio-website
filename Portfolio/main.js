...
const linkAction = ()=>{
    const navMenu = document.getElementById('nav-menu')  
    /* When we click on each nav_ link, we remove the show-menu class*/  navMenu.classList.remove('show-menu')
}  
...
const sendEmail = (e) =>{
    ...
    emailjs.sendForm('service_96ooysh' , 'template_61igqli' , '#contact-form' , 'ZPqTpRCwUlnbkNlIE')
    .then(() =>{
        //show sent message
...
themeButton.addEventListener('click', () => {  
    ...
    // We save the theme and the current icon thatrthe user chose
